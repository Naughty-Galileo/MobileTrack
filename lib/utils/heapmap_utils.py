...
#         print('gt_wh', gt_wh.shape) torch.Size([24, 2])
#         print('min_overlap', min_overlap) min_overlap 0.7
...
#         print('width: ', width) width:  tensor([5.4420, 3.3388, 3.9212, 2.4916, 5.0246, 6.5000, 5.4781, 2.0505, 3.3841,
#         5.3096, 4.9078, 3.2727, 1.5324, 4.2784, 2.0253, 2.8789, 3.2738, 2.4003,
#         3.1183, 4.9123, 3.2783, 4.2353, 4.2857, 7.3752], device='cuda:0')
#         print('height', height) height tensor([ 2.7960,  2.3471,  5.4176,  4.1612,  3.9579,  3.6923,  1.8476,  3.6421,
#          3.4475,  3.7926,  1.8720,  3.2727,  5.9544,  5.7126,  5.4459,  5.4256,
#          4.9491,  5.1301, 10.6882,  3.1579,  5.0153,  5.1765,  2.8571,  3.3651],
#        device='cuda:0')
        a1 = 1
        b1 = height + width
