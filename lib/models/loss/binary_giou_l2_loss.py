...
from lib.models.loss.matcher import build_matcher
from lib.models.loss import box_ops
...
class SetCriterion(nn.Module):
    ...
    """
    def __init__(self, num_classes, matcher, weight_dict, eos_coef, losses=['labels', 'boxes']):
...
def tracking_loss(settings, weight_dict):
    num_classes = 1
