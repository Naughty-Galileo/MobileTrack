...
cfg.MODEL.BACKBONE.PRETRAIN_FILE = ""
cfg.MODEL.BACKBONE.STRIDE = 16

# CORRELATION
cfg.MODEL.CORRELATION = False
cfg.MODEL.CORRELATION_TYPE = ""
cfg.MODEL.CORRELATION_CHANNELS = 256

# MODEL.HEAD
cfg.MODEL.HEAD = edict()
cfg.MODEL.HEAD.FEATURE_SIZE = 32
cfg.MODEL.HEAD.TYPE = "MLP"
cfg.MODEL.HEAD.NUM_CHANNELS = 256
cfg.MODEL.HEAD.HEAD_DIM = 256
...
cfg.TRAIN.SCHEDULER.MILESTONES = [40, 80]
cfg.TRAIN.SCHEDULER.GAMMA = 0.1

# cfg.TRAIN.sparsity_train = False
# cfg.TRAIN.uniform_search = True
# cfg.TRAIN.head_search = True
# cfg.TRAIN.w1 = 1
# cfg.TRAIN.w2 = 1
# cfg.TRAIN.w3 = 0
# cfg.TRAIN.budget_attention = 1
# cfg.TRAIN.budget_mlp = 1
# cfg.TRAIN.pruning_type = 0  # 1 for naive pruning, 2 for layerwise pruning
# cfg.TRAIN.pretrain = ""
